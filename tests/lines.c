...
/* test_strange --
 *
 *	Draws a strange objet in the middle of the screen. This is meant to test the
 *	algorithm for the special cases of a tca_table with more than 2 entries
 */
void test_strange(ei_surface_t surface, ei_rect_t* clipper)
{
	ei_color_t		color		= { 0, 255, 255, 255 };
	ei_linked_point_t	pts[13];

	pts[0].point.x = 100; pts[0].point.y = 100;
	pts[1].point.x = 600; pts[1].point.y = 100;
	pts[2].point.x = 600; pts[2].point.y = 400;
	pts[3].point.x = 500; pts[3].point.y = 400;
	pts[4].point.x = 500; pts[4].point.y = 200;
	pts[5].point.x = 300; pts[5].point.y = 200;
	pts[6].point.x = 300; pts[6].point.y = 400;
	pts[7].point.x = 200; pts[7].point.y = 400;
	pts[8].point.x = 200; pts[8].point.y = 200;
	pts[9].point.x = 150; pts[9].point.y = 200;
	pts[10].point.x = 150; pts[10].point.y = 500;
	pts[11].point.x = 100; pts[11].point.y = 500;
	pts[12].point.x = 100; pts[12].point.y = 100;
	...
	/* Draw the form with polylines or polygon */
 ...
 *	algorithm for the special cases of a tca_table with more than 2 entries
 */
void test_flooring(ei_surface_t surface, ei_rect_t* clipper)
{
	ei_color_t		color		= { 255, 0, 0, 100 };
	ei_color_t		color1		= { 0, 255, 255, 100 };
	ei_linked_point_t	pts[4], pts1[4];

	pts[0].point.x = 100; pts[0].point.y = 100;
	pts[1].point.x = 500; pts[1].point.y = 100;
	pts[2].point.x = 100; pts[2].point.y = 400;
	pts[3].point.x = 100; pts[3].point.y = 100;

	pts1[0].point.x = 500; pts1[0].point.y = 100;
	pts1[1].point.x = 500; pts1[1].point.y = 400;
	pts1[2].point.x = 100; pts1[2].point.y = 400;
	pts1[3].point.x = 500; pts1[3].point.y = 100;

    int i;
	for(i = 1; i <= 3; i++) {
		pts[i-1].next = &(pts[i]);
		pts1[i-1].next = &(pts1[i]);
	}
	/* End the linked list */
	pts[i-1].next = NULL;
	pts1[i-1].next = NULL;
...
int ei_main(int argc, char** argv)
{
	...
	/* Tests. */
	//test_strange	(main_window, clipper_ptr);
	//test_octogone	(main_window, clipper_ptr);
	//test_square	(main_window, clipper_ptr);
	//test_line	(main_window, clipper_ptr);
	//test_dot	(main_window, clipper_ptr);
	test_flooring	(main_window, clipper_ptr);
